 ...
 */
final class Version20220814103112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT DEFAULT NULL, DROP category, DROP tags');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category VARCHAR(255) NOT NULL, ADD tags VARCHAR(255) NOT NULL, DROP category_id');
    }
}
